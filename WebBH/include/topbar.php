...
<!-- top-header -->
    <div class="row">
          <div class="column1" style="background-color:#fbaf32;">
            <div class="col-lg-12 header-most-top" >
                <p class="text-white text-lg-left text-center">CỬA HÀNG THÚ CƯNG ANHKLEE</p>
            </div>
          </div>
          <div class="column2" style="background-color:#fbaf32;">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
