...
<head>
    ...
    <link rel="stylesheet" href="../admin/style/vendors/iconly/bold.css">
...
<body>
    ...
    <div class="sidebar-header">
        <div class="d-flex justify-content-between">
            <div class="logo">
                <a href="index.html"><img src="../Admin/style/images/logo/logoanhklee.png" alt="Logo" style="height:60px;"></a>
            </div>
            <div class="toggler">
...
<div class="page-heading">
    <h3>Chào mừng ông chủ quay trở lại</h3>
</div>
<div class="page-content">
                ...
                <div class="card-body py-4 px-5">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="../Admin/style/images/faces/1.jpg" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                            <h5 class="font-bold"><?php echo $_SESSION['dangnhap'] ?></h5>
                            <h6 class="text-muted mb-0"><a href="?login=dangxuat">Đăng xuất</a></h6>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../Admin/style/vendors/apexcharts/apexcharts.js"></script>
    <script src="../Admin/style/js/pages/dashboard.js"></script>
