				...
				?>
					...
					?>
                                    <tr>
                                        ...
                                        <td width="850px"><?php echo $row_category['tendanhmuc'] ?></td>
                                        <td>
                                            <a href="?quanly=capnhat&id=<?php echo $row_category['danhmuctin_id'] ?>" class="btn btn-warning">Sửa</a> |
                                            <a href="?xoa=<?php echo $row_category['danhmuctin_id'] ?>" class="btn btn-danger">Xóa</a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
